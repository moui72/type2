...
export default {
  home: {
    intro: (
      <div>
        <p>
          Welcome! This site is currently a work in progress. Check back soon to
          see how it develops.
        </p>
        <p>
  ...
  designs: {
    intro:
      "Selected designs. These are mock-ups or demos, not live sites, unless otherwise stated.",
    items: [
      {
        title: "Underpowered",
    ...
    items: [
      {
        ...
        ss:
          "http://peckenpaugh.us/wp-content/uploads/2017/11/teleplaza.gc_.cuny_.edu_.png"
      },
      {
        title: "RankGames",
        description:
          "This app is intended to help you build ranked lists of games from those in your " +
          "collection on Board Game Geek.",
        url: "http://rankgames.ty-pe.com/",
        techs: ["Angular 2", "Ionic", "TypeScript"],
    ...
    items: [
      {
        section: "strengths",
        items: [
          "High level of expertise and experience with HTML, CSS and JavaScript",
          "Proficient with several front-end JavaScript libraries, including JQuery and Ang" +
            "ularJS",
      ...
      },
      {
        section: "objective",
        items: [
          "Create elegant, functional applications and responsive websites."
        ]
      },
      {
        ...
        items: [
          {
            ...
            date: "2014-2015",
            duty:
              "Created and maintained website content for the linguistics department using the " +
              "Kentico CMS."
          },
          {
            employer:
              "Writing in the Disciplines, LaGuardia Community College, CUNY",
            location: "Long Island City, NY",
            position: "Writing Fellow",
            date: "September 2013 - June 2014",
            duty:
              "Lead seminars meant to help faculty from various disciplines integrate writing i" +
          ...
          },
          {
            ...
            duty:
              "Collected and entered data for a projected related to literacy and bilingualism." +
          ...
          },
          {
            ...
            duty:
              "Built and maintained a content management system for an online news magazine, an" +
          ...
          },
          {
            ...
            duty:
              "Wrote content, designed graphics, and technically maintained a website which edu" +
          ...
          },
          {
            ...
            duty:
              "Designed websites and web applications for numerous freelance clients, and provi" +
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            location: "Bellingham, WA",
            degree:
              "Double major B.A. in Theoretical Linguistics, English Literature",
      ...
      },
      {
        ...
        items: [
          "Experience with LaTeX typesetting software",
          "Experience with Wordpress, Drupal and Kentico content management systems",
          "Extensive research and academic writing experience",
          "Experience with SPSS and R statistical packages"
        ]
      },
      {
